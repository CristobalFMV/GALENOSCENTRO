...
from .views import administrador, home, registrarUsuario,eliminarUsuario,editarUsuario, editUsuario,calendario,secretaria,paciente,crearUsuario, agendarhora
urlpatterns = [
    path('', home, name="home"),
